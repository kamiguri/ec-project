...
Route::middleware(['auth:sellers', 'verified'])->group(function () {
    ...
    Route::get("/item/{item_id}/edit",[SellerItemController::class,"edit"])->name("seller.edit");
    Route::post("/item/{item_id}/edit",[SellerItemController::class,"update"])->name("seller.update");
    // ...他のseller側の商品管理ルート...
